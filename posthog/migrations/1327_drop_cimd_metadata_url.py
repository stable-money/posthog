...
class Migration(migrations.Migration):
    ...
    1326 removed the field from Django state, so this is the database half of that drop and
    carries no state operation. Land it only once 1326 has been deployed for a full deploy
    ...
    dependencies = [("posthog", "1326_untrack_cimd_metadata_url")]
