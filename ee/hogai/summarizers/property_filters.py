...
PROPERTY_FILTER_VERBOSE_NAME: dict[PropertyOperator, str] = {
    ...
    PropertyOperator.STARTS_WITH: "starts with",
    PropertyOperator.NOT_STARTS_WITH: "doesn't start with",
    PropertyOperator.ENDS_WITH: "ends with",
    PropertyOperator.NOT_ENDS_WITH: "doesn't end with",
