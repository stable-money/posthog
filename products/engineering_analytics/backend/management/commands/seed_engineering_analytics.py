...
def _deployment_rows(prs: list[dict[str, Any]]) -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        deployments, deployment_statuses = _deployment_rows(prs)
        ...
        deployments = [self._shift_dates(row, ("created_at",), shift) for row in deployments]
        deployment_statuses = [self._shift_dates(row, ("created_at",), shift) for row in deployment_statuses]
        if shift:
